...
a persistence unit "gestionatorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "gestionator/pom.xml":
...
artifact ("gestionator.war") is already built. You can build
